...
PROJECT_ID = os.environ.get("GCP_PROJECT_ID", "datapipeline01-369412")
BUCKET_1 = os.environ.get("GCP_GCS_BUCKET_1", "data-pipeline-godoy-combustiveis-brasil-curated")
