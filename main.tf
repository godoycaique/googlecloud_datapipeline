...
module "bucket-raw" {
  ...
  name       = "data-pipeline-godoy-combustiveis-brasil-raw"
  project_id = var.project_id
  location   = var.region
}
...
module "bucket-curated" {
  ...
  name       = "data-pipeline-godoy-combustiveis-brasil-curated"
  project_id = var.project_id
  location   = var.region
}
...
module "bucket-pyspark-tmp" {
  ...
  name       = "data-pipeline-godoy-combustiveis-brasil-pyspark-tmp"
  project_id = var.project_id
  location   = var.region
}
...
module "bucket-pyspark-code" {
  ...
  name       = "data-pipeline-godoy-combustiveis-brasil-pyspark-code"
  project_id = var.project_id
  location   = var.region
}